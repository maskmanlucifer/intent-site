...
const PrivacyPolicy = () => {
  return (
    <div className="privacy-policy">
      <h1>Privacy Policy <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#000000" fill="none">
    ...
    <path d="M19 11.4999L17.9425 4.71233C17.7268 3.32807 16.2232 2.578 15.0093 3.24907L14.3943 3.58903C12.9019 4.414 11.0981 4.414 9.60574 3.58903L8.99074 3.24907C7.77676 2.578 6.27318 3.32808 6.05751 4.71233L5 11.4999" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
      ...
      <p>
        This Privacy Policy outlines the data we collect, why we collect it, how
        it’s handled, and your rights regarding your data. We are committed to
        safeguarding your privacy and will never sell your data.
      </p>
      </div>
      <div className="block transparency">
      <h3>Transparency and Data Collection <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#000000" fill="none">
    <path d="M16 9C16 12.866 12.866 16 9 16C5.13401 16 2 12.866 2 9C2 5.13401 5.13401 2 9 2C12.866 2 16 5.13401 16 9Z" stroke="currentColor" stroke-width="1.5" />
    ...
    <path d="M6.5 2.5L15.5 11.5M2.5 6.5L11.5 15.5" stroke="currentColor" stroke-width="1.5" />
      ...
      <p>
        ...
        marketing purposes. Your information is yours, and we intend to keep it
        that way.
      </p>
      <h4>Data for Better Service</h4>
      <p>
        The data we collect is strictly to improve your experience. For example,
        aggregate data helps us understand which features you find most useful
        and which may need improvement.
      </p>
      </div>
      <div className="block data">
      <h3>Personal Data We Collect <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#000000" fill="none">
    ...
    <path d="M8 15V17" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
      ...
      <p>
        ...
        storage, meaning it is only accessible to you. In the future, we plan to
        move storage to a secure Service Provider to enable multi-device access.
        When this change occurs, we will notify you.
      </p>
      <h4>Website Interactions</h4>
      <p>
        When you browse our website, we collect information automatically shared
        by your browser, such as your operating system, browser version, the
        pages you visit, and referring websites. This data is used for
        statistical purposes, testing designs, and improving our services.
      </p>
      </div>
      <div className="block">
      ...
      <p>
        Our use and transfer of information received through Google APIs adhere
        to the{" "}
    ...
    <path d="M19 17C19 17.8284 18.3284 18.5 17.5 18.5C16.6716 18.5 16 17.8284 16 17C16 16.1716 16.6716 15.5 17.5 15.5C18.3284 15.5 19 16.1716 19 17ZM19 17V17.5C19 18.3284 19.6716 19 20.5 19C21.3284 19 22 18.3284 22 17.5V17C22 14.5147 19.9853 12.5 17.5 12.5C15.0147 12.5 13 14.5147 13 17C13 19.4853 15.0147 21.5 17.5 21.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
        ...
        <a href="mailto:brightpixellabs@gmail.com">brightpixellabs@gmail.com</a>
      </p>
      </div>
    </div>
  );
